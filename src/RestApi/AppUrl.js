class AppUrl {
    ...
    static BaseUrl = 'https://siteapi.akib.website';
    static heroArea = this.BaseUrl + '/heroArea';
    static techDesc = this.BaseUrl + '/techDesc';
    static clientHome = this.BaseUrl + '/clientHome';
